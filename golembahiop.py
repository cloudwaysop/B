...
bot = telebot.TeleBot('7671266463:AAFEf0Q_sLonZEhd8dpkX5FD5nL1nlIp6Ek')
...
def add_user(message):
    ...
    if user_id in admin_id:
        ...
        response = " ʙᴜʏ ᴋʀᴏ :- @YAMRAJ_PAPA12 ❄."
...
def handle_bgmi(message):
    ...
    if user_id in allowed_user_ids:
        ...
        response = ("🚫 Unauthorized Access! 🚫\n\nJOIN BOTH CHANNELS TO GET FREE OR PAID ACCES \n\n @YAMRAJ_PAPA12 AND @YAMRAJ_PAPA12 \n\n NOW SEND YOUR USER ID TO @YAMRAJ_PAPA12 FOR APPROVAL ")
...
3. MAKE SURE YOU JOINED @YAMRAJ_PAPA12 OTHERWISE NOT WORK
...
def welcome_plan(message):
    user_name = message.from_user.first_name
    response = f'''{user_name}, ʙᴜʏ ᴋʀᴏ :- @YAMRAJ_PAPA12 ❄
'''
    bot.reply_to(message, response)
